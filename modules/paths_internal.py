...
parser_pre.add_argument("--data-dir", type=str, default=os.path.dirname(modules_path), help="すべてのユーザーデータが保存される基本パス", )
parser_pre.add_argument("--models-dir", type=str, default=None, help="モデルが保存されている基本パス。--data-dir を上書きします", )
